...
| | Bateria de lítio | Gerador Diesel |
|---|---|---|
| Tempo de resposta | Milissegundos (< 500ms) | 10 a 30 segundos |
| Interrupção perceptível | Não | Sim |

Uma bateria com inversor integrado assume a carga em menos de 500 milissegundos. Em configurações com UPS (nobreak industrial), esse tempo cai para menos de 10 milissegundos.
...
Para operações onde continuidade absoluta é crítica, como avicultura, câmaras frias e processos industriais contínuos, essa diferença de tempo de resposta importa. Para operações com maior tolerância à interrupção, o gerador diesel pode ser suficiente.
...
O custo inicial de uma bateria de lítio pode ser igual ou superior ao de um gerador diesel de mesma capacidade. Mas ao longo de 10 anos, o custo total de propriedade (TCO) muda significativamente.
...
A bateria de lítio não tem partes móveis, não consome combustível e não exige manutenção de rotina. Os sistemas modernos fazem autodiagnóstico e reportam status remotamente.

## Vida útil e ciclos

As baterias de lítio suportam entre 4.000 e 8.000 ciclos completos de carga e descarga, dependendo do fabricante e da profundidade de descarga. Na prática, isso significa uma vida útil de 10 a 15 anos em condições normais de uso.
...
No entanto, a maioria dos apagões no Brasil dura menos de 4 horas. E para esses eventos, a bateria de lítio cobre a necessidade com folga, sem as desvantagens do diesel.
...
**Camada 1: Bateria de lítio** assume instantaneamente quando a rede cai. Zero interrupção. Cobre os primeiros minutos ou horas, dependendo da capacidade instalada.
...
A bateria ganha uma vantagem adicional quando integrada com painéis solares. Durante o dia, o excedente da geração solar carrega a bateria. Se a rede cai durante o dia, a bateria e o solar trabalham juntos, aumentando a autonomia.
...
Se cada segundo importa, como em avicultura, câmaras frias, processos industriais contínuos ou data centers, a bateria de lítio é a solução certa, seja sozinha ou em conjunto com o gerador existente.
